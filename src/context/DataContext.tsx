...
type DataContextType = {
  ...
  isLoading: boolean;
  fetchError: string | null;
  localFiles: { buyer: File | null; seller: File | null };
  setLocalFiles: (files: { buyer: File | null; seller: File | null }) => void;
  forecastResult: any;
  setForecastResult: (result: any) => void;
  forecastParams: ForecastParams;
  setForecastParams: (params: ForecastParams) => void;
  showResults: boolean;
  setShowResults: (v: boolean) => void;
  showPOButton: boolean;
  setShowPOButton: (v: boolean) => void;
  poResult: any;
  setPoResult: (v: any) => void;
};
...
export const DataProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const [forecastParams, setForecastParams] = useState<ForecastParams>(null);

  // Add state inside DataProvider
