...
//   s3: [
//     [
//       { key: "ak", label: "Access key ID", placeholder: "AKIA...", type: "password" },
//       { key: "sk", label: "Secret access key", placeholder: "wJalr...", type: "password" },
//     ],
//     [
//       { key: "region", label: "Region", placeholder: "ap-south-1", colSpan: 2 },
//     ],
//   ],
//   adls: [
//     [
//       { key: "account", label: "Storage account name", placeholder: "demandforecastingdls" },
//       {
//         key: "akey", label: "Account key", placeholder: "base64-encoded key...", type: "password",
...
//   onelake: [
//     [
//       { key: "tid", label: "Tenant ID", placeholder: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" },
//       { key: "cid", label: "Client ID", placeholder: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" },
//     ],
//     [
//       { key: "csec", label: "Client secret", placeholder: "your-client-secret", type: "password", colSpan: 2 },
//     ],
//   ],
//   local: [],
//   snowflake: [
...
//   sap: [
//     [
//       { key: "host", label: "Host", placeholder: "sap.example.com" },
//       { key: "sysnr", label: "System number", placeholder: "00" },
//     ],
//     [
//       { key: "client", label: "Client", placeholder: "100" },
//       { key: "user", label: "Username", placeholder: "SAP_USER" },
//     ],
//     [
//       { key: "password", label: "Password", placeholder: "••••••••", type: "password", colSpan: 2 },
//     ],
//   ],
//   databases: [
//     [
//       { key: "type", label: "Database type", placeholder: "PostgreSQL / MySQL / MSSQL" },
...
//   databricks: [
//     [
//       { key: "host", label: "Workspace URL", placeholder: "adb-123.azuredatabricks.net", colSpan: 2 },
//     ],
//     [
//       { key: "token", label: "Personal access token", placeholder: "dapi...", type: "password", colSpan: 2 },
//     ],
//     [
//       { key: "cluster", label: "Cluster ID", placeholder: "0123-456789-abcdefgh" },
...
//         const fd = new FormData();
//         fd.append("buyer_account_name", bp.account); fd.append("buyer_filesystem", bp.container);
//         fd.append("buyer_path", bp.path); fd.append("buyer_account_key", authParams.akey || "");
//         fd.append("seller_account_name", sp.account); fd.append("seller_filesystem", sp.container);
//         fd.append("seller_path", sp.path); fd.append("seller_account_key", authParams.akey || "");
...
//                 {effectiveSelection.length !== 1 ? "s" : ""} loaded from {modalSrc?.name}
//               </p>
//             </div>
//           </div>
//         )}
